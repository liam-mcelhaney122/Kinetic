...
name: kinetic
description: >
  AI personal trainer for the Kinetic workout app. Call this agent to generate
  a progressive workout plan based on your training history, or to log and
  complete a session. Requires the Kinetic MCP server to be running with the
  backend on http://localhost:8000.
model: claude-opus-4-7
tools:
  - mcp__kinetic__list_exercises
  - mcp__kinetic__list_workouts
  - mcp__kinetic__create_exercise
  - mcp__kinetic__create_workout
  - mcp__kinetic__get_workout
  - mcp__kinetic__update_workout
  - mcp__kinetic__complete_workout
---
